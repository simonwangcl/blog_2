...
@section('link')
    ...
    <!-- 编辑器源码文件 -->
    <script src="{{ URL::asset('/thirdparty/ueDitor/ueditor.all.min.js') }}"></script>
...
<form class="form-horizontal ajax-form" action="/admin/article" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input name="title" class="form-control" type="text" required="required" aria-invalid="true" minlength="5" maxlength="50">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input name="sketch" class="form-control" type="text" required="required" aria-invalid="true" minlength="10" maxlength="300">
