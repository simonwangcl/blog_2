        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input id="username" name="username" class="form-control" type="text"
                       aria-invalid="true" class="valid" minlength="2" maxlength="30">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input id="email" name="email" class="form-control" type="text"
                       aria-invalid="true" class="valid" minlength="5" maxlength="30">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input id="phone" name="phone" class="form-control" type="text"
                       aria-invalid="true" class="error" number minlength="11" maxlength="11">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                ...
                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 密码于 6 - 15 个字之间</span>
            </div>
        </div>
        <div class="form-group">
