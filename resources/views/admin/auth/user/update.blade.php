...
<form class="avatar-form" action="/admin/upload?type=avatar" enctype="multipart/form-data" method="post">
                    ...
                    <div class="modal-body">
                        <div class="avatar-body">
                            ...
                            <div class="avatar-upload">
                                <input type="hidden" class="avatar-src" name="avatar_src" value="{{ $model->image }}">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary" data-method="rotate"
                                                data-option="-90" title="Rotate -90 degrees">左转90°</button>
                                    </div>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary" data-method="rotate"
                                                data-option="90" title="Rotate 90 degrees">右转90°</button>
                                    </div>
                                </div>
                                <div class="col-md-3">
    ...
    <form class="form-horizontal m-t ajax-form" action="/admin/user/{{ $model->id }}" id="signupForm" method="put">
        <div class="form-group">
            ...
            <div class="avatar-view" title="点击上传头像，只能上传JPG,JPEG,GIF,PNG格式的图片！">
                <img src="{{ $model->image }}" alt="头像">
                <input type="hidden" name="avatar" value="{{ $model->image }}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <select class="form-control" name="role_id" autocomplete="off">
                    ...
                    @foreach($roles as $role)
                        <option value="{{ $role->id }}" @if($model->role_id == $role->id)selected="selected"@endif>{{ $role->name }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input id="username" name="username" class="form-control" type="text"
                       aria-invalid="true" class="valid" minlength="2" maxlength="30" value="{{ $model->name }}">
                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 用户名 2 - 30 字之间</span>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input id="email" name="email" class="form-control" type="text"
                       aria-invalid="true" class="valid" minlength="5" maxlength="30" value="{{ $model->email }}">
                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 邮箱于 5 - 30 个字之间</span>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input id="phone" name="phone" class="form-control" type="text"
                       aria-invalid="true" class="error" number minlength="11" maxlength="11" value="{{ $model->phone }}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                ...
                <span class="help-block m-b-none">
                    <i class="fa fa-info-circle"></i> 密码于 6 - 15 个字之间,不填表示不修改
                </span>
            </div>
        </div>
        <div class="form-group">
