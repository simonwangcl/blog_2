    ...
    <div class="container" id="crop-avatar">
        ...
        <form class="form-horizontal m-t ajax-form" action="/admin/user/{{ $model->id }}" id="signupForm" method="put">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="username" name="username" class="form-control" type="text" aria-invalid="true" class="valid" minlength="2" maxlength="30" value="{{ $model->name }}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="email" name="email" class="form-control" type="text" aria-invalid="true" class="valid" minlength="5" maxlength="30" value="{{ $model->email }}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="phone" name="phone" class="form-control" type="text" aria-invalid="true" class="error" number minlength="11" maxlength="11" value="{{ $model->phone }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 密码于 6 - 15 个字节之间,不填表示不修改</span>
                </div>
            </div>
            <div class="form-group">
