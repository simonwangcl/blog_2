...
<div class="tabs-container col-sm-8">
    <ul class="nav nav-tabs">
        @if($type == 'avatar')
            <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true"> 头像修改 </a></li>
        @else
            <li><a data-toggle="tab" href="#tab-1" aria-expanded="false">头像修改 </a></li>
        @endif
        @if($type == 'info')
            <li class="active"><a data-toggle="tab" href="#tab-2" aria-expanded="true"> 资料修改 </a></li>
        @else
            <li><a data-toggle="tab" href="#tab-2" aria-expanded="false">资料修改 </a></li>
        @endif
        @if($type == 'password')
            <li class="active"><a data-toggle="tab" href="#tab-3" aria-expanded="true"> 密码修改 </a></li>
        @else
            <li><a data-toggle="tab" href="#tab-3" aria-expanded="false">密码修改 </a></li>
        @endif
        @if($type == 'bind')
            <li class="active"><a data-toggle="tab" href="#tab-4" aria-expanded="true"> QQ绑定 </a></li>
        @else
            <li><a data-toggle="tab" href="#tab-4" aria-expanded="false">QQ绑定 </a></li>
        @endif
    </ul>
    <div class="tab-content">
        <div id="tab-1"
                            ...
                            <div class="modal-body">
                                <div class="avatar-body">
                                    ...
                                    <div class="avatar-upload">
                                        <input type="hidden" class="avatar-src" name="avatar_src" value="{{ $user->image }}">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary" data-method="rotate"
                                                        data-option="-90" title="Rotate -90 degrees">左转90°
                                                </button>
                                            </div>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary" data-method="rotate"
                                                        data-option="90" title="Rotate 90 degrees">右转90°
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
            ...
            <div class="panel-body">
                <form class="form-horizontal m-t ajax-form" action="/admin/info/{{ $user->id }}" method="put">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="username" name="username" class="form-control" type="text" required="required"
                                   aria-invalid="true" minlength="2" maxlength="30" value="{{ $user['name'] }}">
                            <span class="help-block m-b-none">
                                <i class="fa fa-info-circle"></i> 用户名 2 - 30 字节之间(一个中文3个字节)
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="email" name="email" class="form-control" type="text" required="required" aria-invalid="true"
                                   minlength="5" maxlength="30" value="{{ $user['email'] }}">
                            <span class="help-block m-b-none">
                                <i class="fa fa-info-circle"></i> 邮箱于 5 - 30 个字节之间
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="phone" name="phone" class="form-control" type="text" required="required" aria-invalid="true"
                                   number minlength="11" maxlength="11" value="{{ $user['phone'] }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-3">
        ...
        <div id="tab-3" class="tab-pane @if($type == 'password') active @endif">
            <div class="panel-body">
                <form class="form-horizontal m-t ajax-form" action="/admin/info/{{ $user->id }}" method="put">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="old" class="form-control" type="text" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">新密码：</label>
                        <div class="col-sm-5">
                            <input name="new" class="form-control" type="password" minlength="6"
                                   maxlength="15" required="required">
                            <span class="help-block m-b-none">
                                <i class="fa fa-info-circle"></i> 密码于 6 - 15 个字节之间
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input name="confirm" class="form-control" type="password" minlength="6" maxlength="15" required="required">
                            <span class="help-block m-b-none">
                ...
                <form class="form-horizontal m-t ajax-form" action="/admin/info/{{ $user->id }}" method="put">
                    ...
                    @if( $user->qqModel )
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                头像：&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{ $user->qqModel->image }}" style="width: 50px"></br></br>
                                昵称：&nbsp;&nbsp;&nbsp;&nbsp;{{ $user->qqModel->name }}</br></br>
                                性别：&nbsp;&nbsp;&nbsp;&nbsp;{{ $user->qqModel->gender }}</br></br>
                                城市：&nbsp;&nbsp;&nbsp;&nbsp;{{ $user->qqModel->province }} - {{ $user->qqModel->city }}
                            </div>
                        </div>
                        <input type="hidden" value="{{ $user->qqModel->id }}" id="qq_id">
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <button class="btn btn-primary qq-unbound" type="button">解除绑定
                                </button>
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 input-group">
                                <input class="form-control" type="text" id="qq-search" data-id="">
